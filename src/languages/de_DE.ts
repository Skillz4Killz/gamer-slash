...
const german: Language = {
  ...
  RANDOM_NAME: "random",
  RANDOM_DESCRIPTION:
    "🔢 Wähle oder sende eine zufällige Nummer oder stelle 8ball eine Frage.",
  ...
  RANDOM_NUMBER_MIN_DESCRIPTION:
    "🔢 Die zufällige Nummer wird höher als dieses minimum sein.",
  RANDOM_NUMBER_MAX_NAME: "maximum",
  RANDOM_NUMBER_MAX_DESCRIPTION:
    "🔢 Die zufällige Nummer wird niedriger als dieses maximum sein.",
  ...
  RANDOM_ADVICE_DESCRIPTION:
    "🗨️ Erhalte einen zufälligen Ratschlag oder Weisheit.",
